...
namespace MOJA.MobileStore.Persistence.Migrations.AppDb
{
    ...
    [Migration("20230801073054_Cart_CartItems_SalePricePropertyToProduct_are_added")]
    partial class Cart_CartItems_SalePricePropertyToProduct_are_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOJA.MobileStore.Domain.Entities.Carts.Cart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MOJA.MobileStore.Domain.Entities.Carts.CartItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MOJA.MobileStore.Domain.Entities.Carts.CartItem", b =>
                {
                    b.HasOne("MOJA.MobileStore.Domain.Entities.Carts.Cart", "Cart")
                        .WithMany("CartItems")
